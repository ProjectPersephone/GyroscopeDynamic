function dx  = HW5_2g (t,x)
format long;
% Function for the ODE45
% Wei Ding
% 11/8/2014
    ...
    %           DE of w_ba
    dw_ba = inv(J_BC_s+J_MbW_s)*(m_Bw_s - CROSS(w_sa)*J_BC_s*w_sa - CROSS(w_ba_s)*J_MbW_s*w_ba_s - J_MbW_s*CROSS(w_sb)*w_ba_s);
